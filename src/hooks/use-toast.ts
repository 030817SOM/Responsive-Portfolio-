...
// Define actionTypes with const assertion for literal types
const actionTypes = {
  ADD_TOAST: "ADD_TOAST",
...
// Define Action type explicitly referencing each action type
type Action =
  | {
...
function genId() {
  // Using a better ID generator, for example, Date.now + random
